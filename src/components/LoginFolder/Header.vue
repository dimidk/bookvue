...
<template>
  ...
  <nav class="navbar">
    <div class="nav-container">
      ...
      <router-link v-if="isAuthenticated()" to="/room" class="nav-item"
        >Εργαστήριο</router-link
      >
      <router-link v-if="isAdmin === true" to="/admin" class="nav-item"
        >Admin</router-link
      >
    </div>
    <div class="auth-buttons">
      <router-link v-if="auth" to="/logout" class="btn"
        >Αποσύνδεση
