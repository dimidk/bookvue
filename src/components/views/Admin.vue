...
<template>
    ...
    <section class="section">
        <p>Ο διαχειριστής έχει την δυνατότητα να ενημερώσει το νέο εξάμηνο με τις ίδιες κρατήσεις των εργαστηρίων από το 
            προηγούμενο εξάμηνο. Αυτό μπορεί να γίνει όταν ο χρήστης που κάνει τις κρατήσεις στείλει σε mail το όνομά του 
            καθώς και το όνομα του εργαστηρίου για το οποίο θέλει να δεσμευτούν οι ίδιες ημέρες και ώρες του εργαστηρίου στο νέο 
            εξάμηνο.
            Επίσης ο διαχειριστής έχει την δυνατότητα της διαγραφής όλων των κρατήσεων.
        </p>
    </section>
     ...
     <section class="section">
        ...
        <fieldset>
            ...
            <div>
                ...
                <input id="bookusername" type="text" placeholder="....όνομα χρήστη κρατήσεων..." v-model="details.bookusername">
            </div>
            <div>
                <label for="labname">Όνομα Εργαστηρίου: &nbsp;&nbsp;</label>
                <input id="labname" type="text" placeholder=".....ΔΕΠΥ Α ή ΔΕΠΥ Β ή ΔΕΠΥ Γ" v-model="details.labname">
            </div>
