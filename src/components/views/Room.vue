...
<template>
    ...
    <div class="nav-bar">
         ...
         <div class="nav-container">
            <input type="text" id="labnames" list="lab" 
                    placeholder="Επίλεξε Εργαστήριο - Αίθουσα" v-model="selectRoom"
            ...
            <Calendar v-if="showRoom !== ''" :selectedRoom="showRoom" :bookuser="user"/>
